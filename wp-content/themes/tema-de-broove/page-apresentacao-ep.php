...
<?php get_header('interno'); ?>
		...
		<section id="apresentacao-ep" class="container-fluid padding-t-5">
			...
			<!-- Inicio da Seção de Modals -->
			<div id="modals" class="row">
				<!-- Modal de TEMA DE BROOVE -->
				...
				<!-- Fim da Modal de TEMA DE BROOVE -->
				...
				<!-- Fim da Modal de PLIN -->

				<!-- Modal de HOJE NÃO PASSA -->
				...
				<!-- Fim da Modal de HOJE NÃO PASSA -->
			</div>
			<!-- Fim da Seção de Modals -->
